...
unsigned char login(unsigned char key)
{
    ...
    if(blocked)
    {
        ...
        clcd_print("Sec Left : ", (0xC0 + 0));
        clcd_putch((sec_left / 10) + '0', (0xC0 + 11));
        clcd_putch((sec_left % 10) + '0', (0xC0 + 12));
...
void menu(unsigned char key)
{
    ...
    if(redraw)
    {
        ...
        {
            clcd_putch('*', (0x80 + 0));
            clcd_print(str[top], (0x80 + 2));

            if(top < 4)
                clcd_print(str[top + 1], (0xC0 + 2));
        }
        else
        {
            clcd_print(str[top], (0x80 + 2));
...
void download_log(void)
{
    ...
    clcd_print("DOWNLOAD DONE  ", (0x80 + 0));
...
int change_password(unsigned char key)
{
    ...
    switch(state)
    {
        ...
        case 0:
            ...
            if(once)
            {
                clcd_print("                ", (0x80 + 0));clcd_print("                ", (0xC0 + 0));
        ...
        case 1:
            ...
            if(index == 4)
            {
                ...
                if(strcmp(temp, temp2) == 0)
                {
                    ...
                    clcd_print("PASSWORD IS    ", (0x80 + 0));
                    clcd_print("CHANGED        ", (0xC0 + 0));
                }
                else
                {
                    clcd_print("RE-ENTERED PWD ", (0x80 + 0));
                    clcd_print("IS WRONG       ", (0xC0 + 0));
                }
