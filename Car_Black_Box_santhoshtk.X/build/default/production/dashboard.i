...
# 8 "dashboard.c" 2
# 1 "/opt/microchip/xc8/v3.10/pic/include/c99/string.h" 1 3
# 25 "/opt/microchip/xc8/v3.10/pic/include/c99/string.h" 3
# 1 "/opt/microchip/xc8/v3.10/pic/include/c99/bits/alltypes.h" 1 3
# 421 "/opt/microchip/xc8/v3.10/pic/include/c99/bits/alltypes.h" 3
typedef struct __locale_struct * locale_t;
# 26 "/opt/microchip/xc8/v3.10/pic/include/c99/string.h" 2 3
...
char *collect_password(unsigned int re_enter){
 ...
 if(re_enter){
  clcd_print("RE-ENTER NEW PASS", (0x80 + 0));
 }
 else{
 ...
 while(1){
  ...
  clcd_putch('_', (0xC0 + curr_pass_index));
  clcd_putch(' ', (0xC0 + curr_pass_index));
...
void change_password(void){
 ...
 if(strcmp(new_password, new_password_re_enter) == 0){
  ...
  clcd_print("PASSWORD MISMATCH", (0x80 + 0));
  _delay((unsigned long)((1500)*(20000000/4000.0)));
  return;
 }
